...
def _cache_key_select_analysisservice(
...
def _cache_key_select_sample_type(
...
class SelectionMacrosView(BrowserView):
    ...
    def select_analyst(self, allow_blank=False, style=None):
        self.style = style
        self.analysts = getUsers(
            self.context, ["Manager", "Analyst", "LabManager"], allow_blank
        )
    ...
    def select_contact(self, style=None):
        self.style = style
        self.contacts = self.pc(
            portal_type="Contact", is_active=True, sort_on="sortable_title"
        )
    ...
    def _select_daterange(
        ...
        self.to_default_value = to_default_value
    ...
    def parse_daterange(self, request, field_id, field_title):
        ...
        if from_date and to_date:
            ...
            parms = translate(_("After ${end_date}", mapping={"end_date": to_date}))
    ...
    def select_instrument(self, style=None):
        self.style = style
        self.instruments = self.bsc(
            portal_type="Instrument", is_active=True, sort_on="sortable_title"
        )
    ...
    def select_profile(self, style=None):
        self.style = style
        self.analysisprofiles = self.bsc(
            portal_type="AnalysisProfile", is_active=True, sort_on="sortable_title"
        )
    ...
    def select_supplier(self, style=None):
        self.style = style
        self.suppliers = self.bsc(
            portal_type="Supplier", is_active=True, sort_on="sortable_title"
        )
    ...
    def select_sampletype(self, allow_blank=True, multiselect=False, style=None):
        ...
        self.allow_blank = allow_blank
        self.multiselect = multiselect
        self.sampletypes = self.bsc(
            portal_type="SampleType", is_active=True, sort_on="sortable_title"
        )
