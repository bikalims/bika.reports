...
#
#  $ bin/test -s bika.reports -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src bika.reports.testing.BIKA_REPORTS_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/bika/reports/tests/robot/test_example.robot
#
